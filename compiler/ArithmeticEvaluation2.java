...
public class ArithmeticEvaluation2 {
    ...
    public enum BinaryOperator {
        ...
        public long eval(Long leftValue, Long rightValue) {
            switch (this) {
                case ADD:
    ...
    public static class BinaryExpression implements Expression {
        ...
        @Override
        public long eval() {
            long leftValue = leftOperand.eval();
            long rightValue = rightOperand.eval();
    ...
    public static Expression parse(String input) {
        ...
        while (curIndex < input.length()) {
            ...
            operands.push(new Number(Long.valueOf(input.substring(startIndex, curIndex))));
        }
